  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-16">
        <div className="flex flex-col lg:grid lg:grid-cols-[2fr_1fr] gap-8 items-center">
          {/* Phone Mockup - First on Mobile, Right on Desktop */}
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end lg:pl-12 animate-fade-in-right w-full lg:w-auto" style={{ animationDelay: '0.5s' }}>
            <div className="relative max-w-[280px] sm:max-w-xs mx-auto">
              {/* Background Effect Elements - Reduced for mobile */}
              <div className="absolute inset-0 transform translate-x-4 sm:translate-x-8 translate-y-4 sm:translate-y-8 bg-gradient-to-br from-gray-300 to-gray-500 rounded-[2.5rem] blur-xl sm:blur-2xl opacity-30 sm:opacity-40 scale-105 sm:scale-110"></div>
              <div className="absolute inset-0 transform translate-x-3 sm:translate-x-6 translate-y-3 sm:translate-y-6 bg-gradient-to-br from-gray-400 to-gray-600 rounded-[2.5rem] blur-lg sm:blur-xl opacity-25 sm:opacity-35 scale-103 sm:scale-107"></div>
              <div className="absolute inset-0 transform translate-x-2 sm:translate-x-4 translate-y-2 sm:translate-y-4 bg-gradient-to-br from-gray-500 to-gray-700 rounded-[2.5rem] blur-md sm:blur-lg opacity-20 sm:opacity-30 scale-102 sm:scale-105"></div>
              <div className="absolute inset-0 transform translate-x-1 sm:translate-x-2 translate-y-1 sm:translate-y-2 bg-gradient-to-br from-gray-600 to-gray-800 rounded-[2.5rem] blur-sm opacity-15 sm:opacity-25 scale-101 sm:scale-103"></div>
              <div className="absolute inset-0 transform translate-x-0.5 sm:translate-x-1 translate-y-0.5 sm:translate-y-1 bg-gradient-to-br from-gray-700 to-gray-900 rounded-[2.5rem] blur-sm opacity-10 sm:opacity-20 scale-100 sm:scale-101"></div>
              ...
              <div className="relative bg-black rounded-[2.5rem] p-1.5 shadow-2xl z-10" style={{ 
                ...
                <div className="absolute top-3 left-1/2 transform -translate-x-1/2 w-20 sm:w-24 h-5 sm:h-6 bg-black rounded-full z-10"></div>
                ...
                <div className="bg-white rounded-[2.25rem] overflow-hidden h-full">
                  ...
                  <div className="bg-[#075E54] px-3 sm:px-4 py-3 sm:py-4 pt-6 sm:pt-8 flex items-center space-x-2 sm:space-x-3 animate-fade-in-up" style={{ animationDelay: '1.0s' }}>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-1">
                        <div className="w-1.5 sm:w-2 h-1.5 sm:h-2 rounded-full animate-pulse" style={{ backgroundColor: '#25D366' }}></div>
                  ...
                  <div className="bg-[#ECE5DD] flex-1 flex flex-col" style={{ 
                    ...
                    <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4 relative" style={{ 
                      scrollbarWidth: 'thin', 
                      scrollbarColor: '#CBD5E0 transparent'
                    }}>
                      {/* Scroll indicator at top */}
                      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-6 sm:w-8 h-0.5 sm:h-1 bg-gray-300 rounded-full opacity-50 z-10"></div>
                    ...
                    <div className="flex justify-end animate-fade-in-right" style={{ animationDelay: '1.5s' }}>
                      <div className="bg-[#DCF8C6] rounded-2xl rounded-br-md p-2.5 sm:p-3 max-w-[240px] sm:max-w-[280px] shadow-sm">
                        <div className="flex items-center space-x-1.5 sm:space-x-2 mb-1.5 sm:mb-2">
                          <div className="w-6 sm:w-7 h-6 sm:h-7 rounded-full flex items-center justify-center" style={{ backgroundColor: '#25D366' }}>
                            <Play className="w-2.5 sm:w-3 h-2.5 sm:h-3 text-white ml-0.5" />
                          </div>
                          <div className="flex-1">
                            {/* Authentic WhatsApp waveform - Responsive */}
                            <div className="flex items-center space-x-0.5 sm:space-x-1 px-1.5 sm:px-2 py-0.5 sm:py-1">
                              {[...Array(20)].map((_, i) => {
                                ...
                                return (
                                  <div 
                                    ...
                                    style={{ 
                                      width: '1.5px', 
                                      height: `${Math.max(heights[i] * 0.8, 2)}px`,
                        ...
                        <div className="flex justify-end items-center space-x-1">
                          ...
                          <div className="flex space-x-0.5">
                            <CheckCircle className="w-2.5 sm:w-3 h-2.5 sm:h-3 text-[#53BDEB]" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-start animate-fade-in-left" style={{ animationDelay: '1.8s' }}>
                      <div className="bg-white rounded-2xl rounded-bl-md p-2.5 sm:p-3 max-w-[220px] sm:max-w-[250px] shadow-sm">
                        <div className="flex items-center space-x-1.5 sm:space-x-2">
                          <Zap className="w-3.5 sm:w-4 h-3.5 sm:h-4 animate-pulse" style={{ color: '#1C2C55' }} />
                          <span className="text-xs sm:text-sm font-medium" style={{ color: '#1C2C55' }}>{t('phoneMockup.aiProcessing')}</span>
                        </div>
                        <div className="mt-1.5 sm:mt-2 h-0.5 sm:h-1 bg-gray-200 rounded-full overflow-hidden">
                    ...
                    <div className="flex justify-start animate-fade-in-left" style={{ animationDelay: '2.1s' }}>
                      <div className="bg-white rounded-2xl rounded-bl-md p-3 sm:p-4 max-w-[260px] sm:max-w-[280px] shadow-sm">
                        ...
                        <div className="text-xs sm:text-sm text-gray-800 leading-relaxed">
                          <div className="font-medium mb-1.5 sm:mb-2" style={{ color: '#1C2C55' }}>{t('phoneMockup.updatedCrm')}</div>
                          ...
                          <div className="space-y-1 sm:space-y-1.5 text-xs sm:text-sm">
                            ...
                            <div className="pt-0.5 sm:pt-1">📝 <strong>{t('phoneMockup.keyNotes')}</strong></div>
                            ...
                            <div className="pt-0.5 sm:pt-1">📋 <strong>{t('phoneMockup.actionItems')}</strong></div>
                        ...
                        <div className="flex justify-end items-center space-x-1 mt-2 sm:mt-3">
                    ...
                    {/* WhatsApp Input Area */}
                    <div className="flex-shrink-0 p-3 sm:p-4 pt-1.5 sm:pt-2">
                      <div className="bg-white rounded-full px-3 sm:px-4 py-1.5 sm:py-2 flex items-center space-x-2 sm:space-x-3 shadow-sm">
                        ...
                        <div className="w-6 sm:w-8 h-6 sm:h-8 rounded-full flex items-center justify-center" style={{ backgroundColor: '#25D366' }}>
                          <Mic className="w-3 sm:w-4 h-3 sm:h-4 text-white" />
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          {/* Hero Text - Left Side */}
          <div className="order-2 lg:order-1 space-y-6 sm:space-y-8 lg:pl-8 lg:pr-12 w-full animate-fade-in-left text-center lg:text-left">
            <div className="space-y-4 sm:space-y-6" style={{ animationDelay: '0.2s' }}>
              <div className="relative">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-3 sm:mb-4 animate-fade-in-up" style={{ color: '#1C2C55', animationDelay: '0.2s' }}>
                  {t('hero.title')}
                </h1>
                <div className="relative inline-block">
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight relative z-10 animate-scale-in" style={{ 
                    color: '#1C2C55',
              ...
              <div className="text-lg sm:text-xl leading-relaxed space-y-1.5 sm:space-y-2" style={{ color: '#202226' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in-up" style={{ animationDelay: '1.2s' }}>
              <button
                onClick={openModal}
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 text-xs sm:text-sm text-gray-500 animate-fade-in-up" style={{ animationDelay: '1.4s' }}>
      ...
      <div className="w-full px-4 sm:px-6">
        ...
        <div className="relative w-full py-6 sm:py-8 max-w-7xl mx-auto">
          ...
          <div className="block lg:hidden space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 sm:p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div className="flex items-center space-x-2">
                  <h4 className="text-base sm:text-lg font-bold" style={{ color: '#1C2C55' }}>Sarah Mitchell</h4>
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  <Phone className="w-3.5 sm:w-4 h-3.5 sm:h-4" style={{ color: '#25D366' }} />
                  <span className="text-xs sm:text-sm font-medium">+32 456 789 123</span>
                </div>
                <div className="text-xs px-2.5 sm:px-3 py-1 rounded-full bg-blue-100 text-blue-700 inline-block">Enterprise Client</div>
              </div>
            </div>

            {/* Voice Note Analysis Card */}
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 sm:p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h4 className="text-base sm:text-lg font-bold" style={{ color: '#1C2C55' }}>Client Summary</h4>
              ...
              <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm" style={{ color: '#202226' }}>
                <div className="flex items-start space-x-2">
                  <div className="w-1.5 h-1.5 rounded-full mt-1.5 sm:mt-2" style={{ backgroundColor: '#1C2C55' }}></div>
                  <div>
                    <div className="font-medium">Budget allocation increased by 40%</div>
                    <div className="text-xs text-gray-600 mt-1">Digital transformation budget expanded</div>
                  </div>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-1.5 h-1.5 rounded-full mt-1.5 sm:mt-2" style={{ backgroundColor: '#1C2C55' }}></div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 sm:p-5">
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-6 sm:w-8 h-6 sm:h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#1C2C55' }}>
                  <Calendar className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-white" />
                </div>
                <h4 className="text-base sm:text-lg font-bold" style={{ color: '#1C2C55' }}>Action Items</h4>
              </div>
              <div className="space-y-2">
                <div className="flex items-start space-x-3 p-2.5 sm:p-3 rounded-lg" style={{ backgroundColor: '#F7E69B' }}>
                  <div className="w-2 h-2 rounded-full mt-1 animate-pulse" style={{ backgroundColor: '#1C2C55' }}></div>
                  <div className="flex-1">
                    <div className="text-xs sm:text-sm font-semibold mb-1" style={{ color: '#1C2C55' }}>Call Sarah Mitchell</div>
          ...
          {/* Desktop: Floating layout (unchanged) */}
