...
export const HeroDemo: React.FC = () => {
  return (
    <div className="w-full">
      ...
      {/* Full CRM Section - Visible when scrolled */}
      <div className="w-full px-6 mt-32">
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden relative hover:shadow-2xl transition-all duration-300">
          ...
          {/* Panel Header */}
          <div className="bg-gray-50 px-8 py-6 border-b border-gray-100 relative z-10">
            <div className="flex items-center justify-between">
              <h3 className="text-2xl font-semibold" style={{ color: '#1C2C55' }}>Complete CRM Integration</h3>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 rounded-full animate-pulse" style={{ backgroundColor: '#25D366' }}></div>
                <span className="text-sm font-medium" style={{ color: '#25D366' }}>Live Sync</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 space-y-8 relative z-10">
            ...
            <div className="bg-blue-50 rounded-2xl p-8 border border-blue-100">
              <div className="flex items-center space-x-4 mb-6">
                <div className="w-16 h-16 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#1C2C55' }}>
                  <Users className="w-8 h-8 text-white" />
                </div>
                <div>
                  <h4 className="text-2xl font-bold" style={{ color: '#1C2C55' }}>Sarah Mitchell</h4>
                  <p className="text-lg text-gray-600">Senior Procurement Manager</p>
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-lg font-medium">+32 456 789 123</span>
                    <span className="text-sm px-3 py-1 rounded-full" style={{ backgroundColor: '#25D366', color: 'white' }}>WhatsApp ✓</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className="text-lg">📧</span>
                    <span className="text-lg">sarah.mitchell@techflow.be</span>
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <span className="text-lg">🏢</span>
                    <span className="text-lg font-medium">TechFlow Solutions</span>
                  </div>
                  <div className="text-sm px-3 py-2 rounded-full bg-blue-100 text-blue-700 inline-block">Enterprise Client</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-yellow-50 rounded-2xl p-8 border border-yellow-100">
              <div className="flex items-center space-x-3 mb-6">
                <Mic className="w-6 h-6" style={{ color: '#F7E69B' }} />
                <h4 className="text-2xl font-bold" style={{ color: '#1C2C55' }}>Latest Voice Note Analysis</h4>
              </div>
              <div className="bg-white rounded-xl p-6">
                <div className="text-lg text-gray-700 space-y-3 mb-4">
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 rounded-full mt-3" style={{ backgroundColor: '#1C2C55' }}></div>
                ...
                <div className="flex items-center justify-between text-sm text-gray-500">
                  ...
                  <span className="px-3 py-2 rounded-full" style={{ backgroundColor: '#F7E69B', color: '#1C2C55' }}>AI Processed</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-purple-50 rounded-2xl p-8 border border-purple-100">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h4 className="text-2xl font-bold" style={{ color: '#1C2C55' }}>Upcoming Tasks & Actions</h4>
              </div>
              <div className="space-y-4">
                <div className="bg-white rounded-xl p-6 border-l-4" style={{ borderColor: '#F7E69B' }}>
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-lg font-semibold" style={{ color: '#1C2C55' }}>Follow-up Call</span>
                    <span className="text-sm px-3 py-1 rounded-full" style={{ backgroundColor: '#F7E69B', color: '#1C2C55' }}>High Priority</span>
                  </div>
                  <div className="text-sm text-gray-600 mb-2">Sarah Mitchell – TechFlow Solutions</div>
                  <div className="text-sm text-gray-700 mb-2">Discuss premium package pricing and implementation timeline.</div>
                  <div className="text-sm text-gray-500">Thursday, Jan 16 – 2:00 PM</div>
                </div>
                <div className="bg-white rounded-xl p-6 border-l-4 border-orange-400">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-lg font-semibold" style={{ color: '#1C2C55' }}>Send Proposal</span>
                    <span className="text-sm px-3 py-1 rounded-full bg-orange-100 text-orange-700">Due Friday</span>
                  </div>
                  <div className="text-sm text-gray-600 mb-2">Include WhatsApp integration demo and ROI calculations</div>
                  <div className="text-sm text-gray-500">Generated from voice note analysis</div>
                </div>
                <div className="bg-white rounded-xl p-6 border-l-4 border-green-400">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-lg font-semibold" style={{ color: '#1C2C55' }}>Prepare Demo</span>
                    <span className="text-sm px-3 py-1 rounded-full bg-green-100 text-green-700">This Week</span>
                  </div>
                  <div className="text-sm text-gray-600 mb-2">Create WhatsApp integration demonstration for client meeting</div>
                  <div className="text-sm text-gray-500">Focus on ROI and efficiency gains</div>
                </div>
              </div>
            </div>
          </div>
