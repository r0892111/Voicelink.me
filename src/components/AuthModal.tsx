  ...
  return (
    <div className={`fixed inset-0 bg-black backdrop-blur-sm flex items-center justify-center z-50 p-3 sm:p-4 transition-all duration-300 ${
      ...
      <div className={`bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 relative transition-all duration-300 ease-out ${
        ...
        <button
          onClick={onClose}
          className="absolute top-4 sm:top-6 right-4 sm:right-6 text-gray-400 hover:text-gray-600 transition-colors p-1 rounded-full hover:bg-gray-100 mobile-touch-target"
        >
        ...
        <div className="text-center mb-6 sm:mb-8 pr-8 sm:pr-0">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-3">{t('auth.modal.title')}</h2>
          <p className="text-base sm:text-lg text-gray-600 mb-3 sm:mb-4">{t('auth.modal.subtitle')}</p>
          ...
          {authProviders.map((provider) => {
            ...
            return (
              <button
                ...
                className={`group w-full bg-white border-2 border-gray-200 hover:border-gray-300 text-gray-800 font-semibold py-4 sm:py-5 px-4 sm:px-8 rounded-2xl transition-all duration-300 hover:shadow-lg hover:scale-[1.02] flex items-center justify-between disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 transform relative overflow-hidden mobile-btn`}
              >
                {isLoading ? (
                  <>
                    <div className="flex items-center justify-center w-full">
                      <Loader2 className="w-5 sm:w-6 h-5 sm:h-6 animate-spin text-gray-600 mr-2 sm:mr-3" />
                      <span className="text-sm sm:text-lg text-gray-600">Connecting to {provider.displayName}...</span>
                    </div>
                  </>
                ) : (
                  <>
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      <div className="w-10 sm:w-12 h-10 sm:h-12 bg-gray-50 rounded-xl flex items-center justify-center group-hover:bg-gray-100 transition-colors flex-shrink-0">
                        <img 
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-xs sm:text-sm text-gray-500">{t('auth.modal.startTrialInstantly')}</div>
                      </div>
                    </div>
                    <div className="w-7 sm:w-8 h-7 sm:h-8 rounded-full bg-gray-100 flex items-center justify-center group-hover:bg-gray-200 transition-colors flex-shrink-0">
                      <svg className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="pt-4 sm:pt-6 border-t border-gray-200">
          ...
          <div className="mb-4 sm:mb-6">
            ...
            {/* Download Options */}
            <div className="mt-2 sm:mt-3 ml-6 sm:ml-7 flex flex-col sm:flex-row items-start sm:items-center space-y-1 sm:space-y-0 sm:space-x-4 text-xs text-gray-600">
              <span>Download:</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 text-center mb-3 sm:mb-4">
            <div className="flex flex-col items-center space-y-1">
              <div className="w-7 sm:w-8 h-7 sm:h-8 rounded-full bg-blue-100 flex items-center justify-center">
                <svg className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="flex flex-col items-center space-y-1">
              <div className="w-7 sm:w-8 h-7 sm:h-8 rounded-full bg-green-100 flex items-center justify-center">
                <svg className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-green-600" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="flex flex-col items-center space-y-1">
              <div className="w-7 sm:w-8 h-7 sm:h-8 rounded-full bg-purple-100 flex items-center justify-center">
                <svg className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
